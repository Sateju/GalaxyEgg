...
abstract class EggDatabase : RoomDatabase() {
     ...
     *
     * For example, clients can call `EggDatabase.getInstance(context)` to instantiate
     * a new EggDatabase.
     */
    companion object {
        /**
         ...
         */
        @Volatile
        private var INSTANCE: EggDatabase? = null
         ...
         */
        fun getInstance(context: Context): EggDatabase {
